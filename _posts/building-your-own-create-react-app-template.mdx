...
excerpt: 'Using CRA (create-react-app) is a convenient and fast way to get started on a React project. Chances are, you have a set of favorite packages and tools that you use when setting up a new project.'
coverImage: '/assets/blog/build-your-own-cra/cover.jpg'
date: '2020-07-02 11:07:30'
author:
  name: 'David Quick'
ogImage:
  url: '/assets/blog/build-your-own-cra/cover.jpg'
tagName: 'React'
---
...
You can then take the `.gitignore` file and move it into the **template** folder. With this, we can also remove the period from the start of the file so that it looks like this: `gitignore`.

> **Note:** Just for clarity, the **gitignore** file **should not** have the `.` in front of it.

We can also delete the following files:
...
This <span>template.json</span> file is where we'll store all of our packages.
...
> **Note:** Make sure you do a quick npm search for the dependencies you want to add and their correct version number.
...
> **Note:** The most important line within this file is "main": "template.json". If you don't have this, you won't be successful in publishing your template.
...
> **Note:** You're free to follow along or create/delete any files and folders on your own from this point on.
