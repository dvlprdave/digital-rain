...
excerpt: "Out of pure meddling and frustration over being stuck on a project for a lot longer than expected, I learned quite a bit about CSS variables and how they allow us to make dynamic changes with ease."
coverImage: '/assets/blog/theming-css-var/cover.jpg'
date: '2020-01-31 07:01:22'
author:
  name: 'David Quick'
ogImage:
  url: '/assets/blog/theming-css-var/cover.jpg'
tagName: 'CSS JavaScript'
---
...
You can view it [**here**](https://codesandbox.io/embed/smoosh-frog-j7x9y?fontsize=14&hidenavigation=1&theme=dark). 
