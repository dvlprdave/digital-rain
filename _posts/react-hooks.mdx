---
title: 'Learn the useState hook by example'
excerpt: "In this guide, we'll take a look into useState by comparing class and function components. This isn't an in-depth look as there are other great features of the useState hook that aren't included in this guide."
coverImage: '/assets/blog/react-hooks/cover.jpg'
date: '2019-11-14 08:11:20'
author:
  name: 'David Quick'
ogImage:
  url: '/assets/blog/react-hooks/cover.jpg'
tagName: 'React'
---
...
You can head [**here**](https://codesandbox.io/embed/vigorous-torvalds-btiky?fontsize=14&hidenavigation=1&theme=dark) to check it out. 
