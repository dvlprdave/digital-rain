...
excerpt: "We'll be focusing on one component in specific that we'll dive into and refactor while focusing on re-usability and props. This came about as I was updating my portfolio and came across a really ugly and inefficient component that needed some work."
coverImage: '/assets/blog/creating-flexible-components/cover.jpg'
date: '2020-09-09 11:09:25'
author:
  name: 'David Quick'
ogImage:
  url: '/assets/blog/creating-flexible-components/cover.jpg'
tagName: 'React'
---
